...
public interface SDLMMInterface {
	...
	public abstract int[] readImageSize(String filename) throws IOException;
	...
	void mode7Render(double angle, int vx, int vy, int[] pixels, int bw, int bh, int x, int y, int w, int h);
