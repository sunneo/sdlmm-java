    ...
    private static class SDLMMPanelImpl extends SDLMMPanel {
        ...
        public SDLMMPanelImpl(int width, int height, boolean doubleBuffered) {
            ...
            this.addKeyListener(new KeyListener() {
                ...
                public void keyPressed(KeyEvent arg0) {
                    if (onKeyboard != null) {
                        onKeyboard.onkey(arg0.getKeyCode(), arg0.isShiftDown(), arg0.isControlDown(), arg0.isAltDown(), true);
                    }
                ...
                public void keyReleased(KeyEvent arg0) {
                    if (onKeyboard != null) {
                        onKeyboard.onkey(arg0.getKeyCode(), arg0.isShiftDown(), arg0.isControlDown(), arg0.isAltDown(), false);
                    }
        ...
        public void paint(Graphics g) {
            ...
            synchronized (g) {
                ...
                g.drawImage(img, 0, 0, this.getWidth(), this.getHeight(), 0, 0, this.getWidth(), this.getHeight(), null);
            }
        }
        ...
        public int[] readImage(String filename) throws IOException {
            ...
            return image.getRaster().getPixels(0, 0, image.getWidth(), image.getHeight(), ret);
        }
        ...
        public void setFont(Font f) {
            if (image != null && image[toDraw] != null) {
                image[toDraw].getGraphics().setFont(f);
            }
            if (!this.isDoubleBuffered()) {
                this.repaint();
            }
